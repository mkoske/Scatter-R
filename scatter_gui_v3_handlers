...
#~ 	sgui$var.selected.attributes_num <- intersect(sgui$var.selected.attributes, sgui$var.attributes_num)
#~ 	sgui$var.selected.attributes_int <- intersect(sgui$var.selected.attributes, sgui$var.attributes_int)
#~ 	sgui$var.selected.attributes_fac <- intersect(sgui$var.selected.attributes, sgui$var.attributes_fac)
#~ 	sgui$var.selected.attributes_flv <- intersect(sgui$var.selected.attributes, sgui$var.attributes_flv)
